...
function preload() {
  spriteSheet = loadImage("assets/Eskimo.png");
  chronoSheet = loadImage("assets/Monk.png");
}
...
function setup() {
  ...
  walkingAnimation = new WalkingAnimation(spriteSheet,80,80,200,100,9);
  walkingAnimation2 = new WalkingAnimation(spriteSheet,80,80,100,300,9);
  chronoAnimation = new WalkingAnimation(chronoSheet,80,80,250,250,9);
}
