...
let spriteSheetFilenames = ["buggie.png"];
let spriteSheets = [];
let animations = [];
...
function reset() {
  game.elapsedTime = 0;
  game.score = 0;
  game.totalSprites = random(5,15);
  game.maxTime = 30;

  animations = [];
  for(let i=0; i < game.totalSprites; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),80,80,random(100,300),random(100,300),4,random(0.5,1),6,random([0,1]));
  }
}
